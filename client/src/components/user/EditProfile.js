...
function EditProfile(props) {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4000/users/edit/${props.auth.user.id}`)
      .then((res) => {
        setUserInfo({
  ...
  const submitUserProfileForm = (event) => {
    ...
    axios
      .put(`http://localhost:4000/users/edit/${props.auth.user.id}`, formData)
      .then((res) => {
      ...
      <Form onSubmit={submitUserProfileForm} className="user-profile-form">
        <Row>
            ...
            <Image
              ...
              src={
                image.preview
                  ? image.preview
                  : userInfo.imageType
                    ? renderImage(userInfo.imageBuffer.data, userInfo.imageType)
          ...
          <Col className="user-profile-body" md={8} xs={12}>
            <Form.Group as={Row}>
              <Form.Label column sm="2" className="user-profile-field">
                <h6>Name</h6>
              </Form.Label>
              <Col sm="10">
                <Form.Control
            ...
            <Form.Group as={Row}>
              ...
              <Col sm="10">
                <Form.Control
                  ...
                  onChange={handleChange}
                />
                <div className="max-length-tooltip">
